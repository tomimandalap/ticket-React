        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="col-12 mt-5">
              <button type="submit" className="btn btn-input w-100">Join for free</button>
            </div>
          </div>
          <div className="row text-center">
            <div className="col-12 mt-5">
              <p className="f-sm">Do you already have an account? <Link className="line" to="/login">Log in</Link></p>
            </div>
            <div className="col-12">
